...
```bash
INIT=$(node "$HOME/.claude/get-shit-done/bin/gsd-tools.js" init map-codebase)
...
```bash
node "$HOME/.claude/get-shit-done/bin/gsd-tools.js" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
