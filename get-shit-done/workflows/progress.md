...
```bash
INIT=$(node "$HOME/.claude/get-shit-done/bin/gsd-tools.js" init progress)
...
- `STATE=$(node "$HOME/.claude/get-shit-done/bin/gsd-tools.js" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "$HOME/.claude/get-shit-done/bin/gsd-tools.js" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "$HOME/.claude/get-shit-done/bin/gsd-tools.js" progress bar --raw)
```
