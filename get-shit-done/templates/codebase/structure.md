...
- Key files: execute-plan.md, plan-phase.md
- Subdirectories: None
...
- Usage: Reference from command with `@/Users/ollorin/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/ollorin/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/ollorin/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
